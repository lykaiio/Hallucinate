    ...
    >
      ...
      {isDarkMode && (
        <>
          ...
          <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-spring-green/35 via-spring-green/10 to-transparent backdrop-blur-lg z-10 pointer-events-none animate-pulse shadow-2xl shadow-spring-green/5" />

          {/* Right side animated blur bar */}
          <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-spring-green/35 via-spring-green/10 to-transparent backdrop-blur-lg z-10 pointer-events-none animate-pulse shadow-2xl shadow-spring-green/5" />
        </>
      )}
      ...
      {/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */}
      <footer className="relative z-20 px-4 mt-4 green justify-between items-end w-full flex-shrink-0">
        {/* Legal disclaimer */}
        <p
